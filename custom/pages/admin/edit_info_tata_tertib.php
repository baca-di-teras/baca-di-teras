...
if (!$info || $info['id_name'] !== 'tata_tertib_point') { header("Location: " . BASE_URL . "/portal-admin/informasi"); exit; }
...
<head>
    <meta charset="UTF-8">
    <title>Edit Poin Tata Tertib</title>
        ...
        <div class="admin-content" style="padding: 32px; max-width: 1200px; margin: 0 auto; width: 100%; box-sizing: border-box;">
            <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px;">
                <div class="page-title">
                    <h1 style="font-size: 1.5rem; font-weight: 700; margin: 0 0 8px 0;">Edit Poin Tata Tertib</h1>
                </div>
