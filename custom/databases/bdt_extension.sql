...
('DTR', 'Perpustakaan Desa Teras', CURDATE(), CURDATE()),
('SD1', 'SD Negeri 1 Teras',      CURDATE(), CURDATE()),
('SD2', 'SD Negeri 2 Teras',      CURDATE(), CURDATE()),
('SP1', 'SMP Negeri 1 Teras',     CURDATE(), CURDATE()),
('SP2', 'SMP Negeri 2 Teras',     CURDATE(), CURDATE());

UPDATE `bdt_library`
SET `status` = 'nonaktif'
WHERE `slug` IN ('perpustakaan-utama', 'taman-baca-komunitas', 'perpustakaan-digital');

INSERT IGNORE INTO `bdt_library`
...
(
    ...
    'Perpustakaan Desa Teras',
    'Pusat literasi utama Desa Teras',
    'Unggulan',
    'aktif',
    'Desa Teras, Boyolali',
    'Desa Teras',
